			...
			<div class="row">
				...
				<div class="col-md-9 main-content">
					...
					<article
						...
						<h4>更新文章</h4>
						<form class="form" action="updateArtitle.html" method="post"
							id="useform">
							<div class="form-group">
								<label class=" control-label">标题：</label> <input type="text"
									class="form-control" name="Atitle" required="required"
									value="${artitle.getAtitle()}">
							</div>
							<div class="form-group">
								<label class=" control-label" for="content">详情：</label>
								<textarea name="Acontent" class="form-control" rows="12"
									required="required">${artitle.getAcontent()}</textarea>
							</div>
							<div class="form-group">
								<input type="hidden" name="id" value="${artitle.getId()}"><br />
								<input type="hidden" name="Aclass"
									value="${artitle.getAclass()}"><br />
