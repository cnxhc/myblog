		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 main-content">
					<h4>更新相册</h4>
					<form class="from" action="updatePhoto.html" method="post"
						enctype="multipart/form-data" id="useform">
						<div class="form-group">
							<label class=" control-label" for="content">名称：</label> <input
								type="text" name="Pname" value="${photo.getPname()}"
								class="form-control" required="required">
						</div>

						<div class="form-group">
							<img alt="图片" src="image/${photo.getPpic()}"
							style="width: 120px; height: 130px;">
							 <input type="file" name="Ppic"  src="image/${photo.getPpic()}">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="hidden" name="id" value="${photo.getId()}"><br />
							<input type="hidden" name="Pclass" value="${photo.getPclass()}"><br />
